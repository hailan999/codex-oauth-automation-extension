        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              ipProxyAppliedHost: prevState.ipProxyAppliedHost,
              ipProxyAppliedPort: prevState.ipProxyAppliedPort,
              ipProxyAppliedRegion: prevState.ipProxyAppliedRegion,
              ipProxyAppliedHasAuth: prevState.ipProxyAppliedHasAuth,
              ipProxyAppliedProvider: prevState.ipProxyAppliedProvider,
              ipProxyAppliedError: prevState.ipProxyAppliedError,
              ipProxyAppliedWarning: prevState.ipProxyAppliedWarning,
              ipProxyAppliedExitIp: prevState.ipProxyAppliedExitIp,
              ipProxyAppliedExitRegion: prevState.ipProxyAppliedExitRegion,
              ipProxyAppliedExitDetecting: prevState.ipProxyAppliedExitDetecting,
              ipProxyAppliedExitError: prevState.ipProxyAppliedExitError,
              ipProxyAppliedExitSource: prevState.ipProxyAppliedExitSource,
